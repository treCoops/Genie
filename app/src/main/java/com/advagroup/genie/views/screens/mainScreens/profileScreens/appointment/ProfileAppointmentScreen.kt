package com.advagroup.genie.views.screens.mainScreens.profileScreens.appointment
...
@Composable
fun ProfileAppointmentScreen(navController: NavController) {
    ...
    Column(
        ...
        Box(
            ...
            LazyColumn(
                ...
                items(getCurrentAppointmentList().size) { index ->
                    AppointmentItemComposable(
                        getCurrentAppointmentList()[index],
                        onPressed = {},
                        onDeleted = {}
                    )
                }
